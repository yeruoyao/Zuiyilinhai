										 ...
										 <section class="dashboard-counts no-padding-bottom">
							                  ...
							                  <div class="card">
							                    ...
							                    <div class="card-header d-flex align-items-center">
							                      <h3 class="h4">非遗项目-板块内容新增</h3>
							                    </div>
							                    <div class="card-body">
							                      <form class="form-horizontal" action="<%=base %>FyxmAddController" method="post">
							                       
							                        <div class="line"></div>
							                        <div class="form-group row">
							                          <label class="col-sm-2 form-control-label">标题</label>
							                          <div class="col-sm-9">
							                            <input type="text"  required="required" placeholder="请输入标题" name="fyxmtitle" class="form-control">
							                          </div>
							                        </div>
							                        ...
							                        <div class="form-group row">
							                          ...
							                          <div class="col-sm-9">
							                            <textarea rows="" cols="" type="text" style="height: 150px"  required="required" placeholder="请输入内容" name="fyxmtext" class="form-control"></textarea>
							                          </div>
							                        </div>
