										 ...
										 <section class="dashboard-counts no-padding-bottom">
							                  ...
							                  <div class="card">
							                    ...
							                    <div class="card-header d-flex align-items-center">
							                      <h3 class="h4">特色小镇-板块内容更新</h3>
							                    </div>
							                    <div class="card-body">
							                 	  <%Tsxz tsxz=(Tsxz)request.getAttribute("tsxz"); %>
				
							                      <form class="form-horizontal" action="<%=base %>TsxzUpdateController" method="post" >
							                        <input name="tsxzid" value="<%=tsxz.getTsxzid()%>" type="hidden"/>
							                        <div class="line"></div>
							                        <div class="form-group row">
							                          <label class="col-sm-2 form-control-label">标题</label>
							                          <div class="col-sm-9">
							                            <input type="text"  required="required" name="tsxztitle" value="<%=tsxz.getTsxztitle()%>" class="form-control">
							                          </div>
							                        </div>
							                        ...
							                        <div class="form-group row">
							                          ...
							                          <textarea style="height: 200px"  required="required" name="tsxztext" class="form-control"><%=tsxz.getTsxztext() %></textarea>
