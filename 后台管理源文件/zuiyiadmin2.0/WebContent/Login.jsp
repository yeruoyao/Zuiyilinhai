          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form class="form-validate" action="<%=base %>Login" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input id="login-password" required="required" type="password" name="password" required data-msg="Please enter your password" class="input-material">
                  ...
                  <small>还没有账号</small><a href="<%=base %>Register" class="注册">请先注册</a>
                </div>
              </div>
            </div>
          </div>
