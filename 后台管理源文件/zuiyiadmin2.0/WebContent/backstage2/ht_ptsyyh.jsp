                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                           <c:forEach items="${findAllTbUser }" var="t"
														varStatus="status">
														<tr>
															<th scope="row">${status.index+1 }</th>
															<form action="${path }/UpdateTbUserServlet" method="post">
																...
																<c:if test="${t.state2==1 }">
																	<td><input type="button" value="禁言"
																		...
																		onclick="window.location.href='${path}/updateState2Servlet?id=${t.id }&state2=1'"></td>
																</c:if>
																<c:if test="${t.state2!=1 }">
																	<td><input type="button" value="正常"
																		class="btn btn-primary" style="width: 60px"
																		onclick="window.location.href='${path}/updateState2Servlet?id=${t.id }&state2=0'"></td>
																</c:if>

																<td><input type="button" value="注销"
																	class="btn btn-primary" style="width: 60px"
																	onclick="window.location.href='${path}/delTbUserServlet?id=${t.id }'"></td>
															</form>
														</tr>
													</c:forEach>
