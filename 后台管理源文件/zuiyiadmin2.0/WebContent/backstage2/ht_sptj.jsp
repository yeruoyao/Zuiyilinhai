                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <form>
                        ...
                        <div class="form-group">       
                          <label class="form-control-label">商品价格</label>
                          <input type="text" placeholder="商品价格" class="form-control">
                        </div>
						  <div class="form-group">       
                          <label class="form-control-label">商品数量</label>
                          <input type="text" placeholder="商品数量" class="form-control">
                        </div>
						 <div class="form-group">       
                          <label class="form-control-label">商品图片1</label>
                          <input type="file" placeholder="商品图片1" >
                        </div>
						   <div class="form-group">       
                          <label class="form-control-label">商品图片2</label>
                          <input type="file" placeholder="商品图片2" >
                        </div>
						   <div class="form-group">       
                          <label class="form-control-label">商品图片3</label>
                          <input type="file" placeholder="商品图片3" >
                        </div>
						   <div class="form-group">       
                          <label class="form-control-label">商品图片4</label>
                          <input type="file" placeholder="商品图片4" >
                        </div>
                        <div class="form-group">       
