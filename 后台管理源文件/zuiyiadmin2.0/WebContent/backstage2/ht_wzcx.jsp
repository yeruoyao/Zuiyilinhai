...
<!--                    <li><a href="${path }/backstage2/forms.jsp"> <i class="icon-padnote"></i>网站信息管理 </a></li>-->
        ...
        <div class="content-inner">
          ...
          <!-- Forms Section-->
          <section class="forms" style="width: 1650px; margin-top: -15px"> 
            <div class="container-fluid">
              <div class="row">
                <!-- Basic Form-->
                <div class="col-lg-8">                           
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form class="form-inline" action="${path }/CheckArticleServlet" method="post">
                        <div class="form-group">
                          <label for="inlineFormInput" class="sr-only">文章作者</label>
                          <input id="inlineFormInput" type="text" placeholder="文章作者" class="mr-3 form-control" name="author">
                        </div>
                        <div class="form-group">
                          <label for="inlineFormInputGroup" class="sr-only">文章名称</label>
                          <input id="inlineFormInputGroup" type="text" placeholder="文章名称" class="mr-3 form-control" name="title">
                        </div>
                        <div class="form-group">
			...
			<section class="forms" style="width: 1650px; margin-top: -100px"> 
            <div class="container-fluid">
              <div class="row">
                <!-- Basic Form-->
                <div class="col-lg-8">                           
                  <div class="card">
                    ...
                    <c:forEach items="${list }" var="t">
                     <form class="form-inline">
                        <div class="form-group">
                          <label for="inlineFormInput" class="sr-only">文章作者</label>
                          <input id="inlineFormInput1" type="text" placeholder="文章作者" class="mr-3 form-control" value="${t.author }">
                        </div>
                        <div class="form-group">
                          <label for="inlineFormInputGroup" class="sr-only">文章名称</label>
                          <input id="inlineFormInputGroup1" type="text" placeholder="文章名称" class="mr-3 form-control" value="${t.title }">
                        </div>
                        <div class="form-group">
                          <input type="button" class="btn btn-primary" value="删除"  style="width: 60px"  onclick="window.location.href='${path}/delArticleServlet?id=${t.id }'">
                        </div>
                      </form>
                      <hr>
                    </c:forEach>
                     ...
                     <form class="form-inline">
                        <div class="form-group">
                          <label for="inlineFormInput" class="sr-only">文章作者</label>
                          <input id="inlineFormInput1" type="text" placeholder="文章作者" class="mr-3 form-control" value="${article.author }">
                        </div>
                        <div class="form-group">
                          <label for="inlineFormInputGroup" class="sr-only">文章名称</label>
                          <input id="inlineFormInputGroup1" type="text" placeholder="文章名称" class="mr-3 form-control" value="${article.title }">
                        </div>
                        <div class="form-group">
                           <input type="button" class="btn btn-primary" value="删除"  style="width: 60px"  onclick="window.location.href='${path}/delArticleServlet?id=${article.id }'">
                        </div>
                      </form>
                      <hr>
