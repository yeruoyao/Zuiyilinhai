            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="${path }/backstage2/index.jsp" class="navbar-brand d-none d-sm-inline-block">
                  <div class="brand-text d-none d-lg-inline-block"><span>网站后台 </span><strong>管理系统</strong></div>
       ...
       <!-- Side Navbar -->
        ...
        <div class="content-inner">
          ...
          <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="${path }/AdminLoginServlet">首页</a></li>
                  ...
                  <div class="card">
                    <div class="card-close">
                      <div class="dropdown">
                        ...
                        <div aria-labelledby="closeCard1" class="dropdown-menu dropdown-menu-right has-shadow"><a href="#" class="dropdown-item remove"> <i class="fa fa-times"></i>关闭</a><a href="#" class="dropdown-item edit"> <i class="fa fa-gear"></i>离开</a></div>
                      </div>
                    </div>
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">用户文章审核</h3>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                          <c:forEach items="${findAllEssay }" var="t" varStatus="i">
                          <tr>
                              <th scope="row">${i.index+1 }</th>
						<form>
                        <td><input value="${t.username }"></td>
                              <td><input value="${t.essaytitle }"></td>
                              <td><input value="${t.essaycontext }" class="wznr"></td>
							  <td><input value="${t.essaytype }"></td>
							  <td><input value="${t.time }"></td>
							  <c:if test="${t.state==0 }">
							   <td><input value="待审核"></td>
							  </c:if>
							  <c:if test="${t.state==1 }">
							   <td><input value="已通过"></td>
							  </c:if>
							  <c:if test="${t.state==2 }">
							   <td><input value="未通过"></td>
							  </c:if>
							  
							  
							  <c:if test="${t.state==0 }">
							  <td><input type="button" class="btn btn-primary" style="width: 60px" value="通过" onclick="window.location.href='${path}/WorksServlet?action=ShiWenState&essayid=${t.essayid }&state=1&userid=${t.userid }'"></td>
							  </c:if>
							  <c:if test="${t.state==1 }">
							  <td><input type="button" class="btn btn-primary" style="width: 60px" value="不通过" onclick="window.location.href='${path}/WorksServlet?action=ShiWenState&essayid=${t.essayid }&state=2&userid=${t.userid }'"></td>
							  </c:if>
							   <c:if test="${t.state==2 }">
							  <td><input type="button" class="btn btn-primary" style="width: 60px" value="通过" onclick="window.location.href='${path}/WorksServlet?action=ShiWenState&essayid=${t.essayid }&state=1&userid=${t.userid }'"></td>
							  </c:if>
							  <td><input type="button" class="btn btn-primary" style="width: 60px" value="删除" onclick="window.location.href='${path}/WorksServlet?action=DelSw&essayid=${t.essayid }'"></td>
