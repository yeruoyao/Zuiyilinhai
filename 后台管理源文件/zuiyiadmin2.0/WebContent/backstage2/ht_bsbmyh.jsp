...
<!-- Bootstrap CSS-->
<link rel="stylesheet"
	href="${path }/backstage2/vendor/bootstrap/css/bootstrap.min.css">
<!-- Font Awesome CSS-->
<link rel="stylesheet"
	href="${path }/backstage2/vendor/font-awesome/css/font-awesome.min.css">
...
<!-- theme stylesheet-->
<link rel="stylesheet" href="${path }/backstage2/css/style.default.css"
	id="theme-stylesheet">
...
<body>
				...
				<div class="container-fluid">
					<div
						...
						<div class="navbar-header">
							<!-- Navbar Brand -->
							<a href="${path }/backstage2/index.jsp"
								class="navbar-brand d-none d-sm-inline-block">
								<div class="brand-text d-none d-lg-inline-block">
									<span>后台 </span><strong>管理系统</strong>
								</div>
							...
							<li class="nav-item dropdown"><a id="notifications"
								...
								<ul aria-labelledby="notifications" class="dropdown-menu">
									<li><a rel="nofollow" href="#" class="dropdown-item">
											<div class="notification">
												<div class="notification-content">
													<i class="fa fa-envelope bg-green"></i>网站有比赛活动到期
												</div>
									...
									<li><a rel="nofollow" href="#" class="dropdown-item">
											<div class="notification">
												<div class="notification-content">
													<i class="fa fa-twitter bg-blue"></i>你收到3条信息
												</div>
												<div class="notification-time">
													<small>5分钟前</small>
												</div>
									...
									<li><a rel="nofollow" href="#" class="dropdown-item">
											<div class="notification">
												<div class="notification-content">
													<i class="fa fa-upload bg-orange"></i>用户**申请会员
												</div>
												<div class="notification-time">
													<small>9分钟前</small>
												</div>
									...
									<li><a rel="nofollow" href="#" class="dropdown-item">
											<div class="notification">
												<div class="notification-content">
													<i class="fa fa-twitter bg-blue">用户会员到期</i>
												</div>
												<div class="notification-time">
													<small>10分钟前</small>
												</div>
									...
									<li><a rel="nofollow" href="#"
										class="dropdown-item all-notifications text-center"> <strong>更多信息</strong></a></li>
								</ul></li>
							<!-- Messages                        -->
							<li class="nav-item dropdown"><a id="messages"
								...
								<ul aria-labelledby="notifications" class="dropdown-menu">
									<li><a rel="nofollow" href="#"
										class="dropdown-item d-flex">
											<div class="msg-profile">
												<img src="${path }/backstage2/img/avatar-1.jpg" alt="..."
									...
									<li><a rel="nofollow" href="#"
										class="dropdown-item d-flex">
											<div class="msg-profile">
												<img src="${path }/backstage2/img/avatar-2.jpg" alt="..."
													class="img-fluid rounded-circle">
											</div>
											<div class="msg-body">
												<h3 class="h5">威廉詹姆士</h3>
												<span>发送给你信息</span>
											</div>
									</a></li>
									<li><a rel="nofollow" href="#"
										class="dropdown-item d-flex">
											<div class="msg-profile">
												<img src="${path }/backstage2/img/avatar-3.jpg" alt="..."
													class="img-fluid rounded-circle">
											</div>
											<div class="msg-body">
												<h3 class="h5">案件一零</h3>
									...
									<li><a rel="nofollow" href="#"
										class="dropdown-item all-notifications text-center"> <strong>全部未读信息
										</strong></a></li>
								</ul></li>
							<!-- Languages dropdown    -->
							<!-- Logout    -->
							<li class="nav-item"><a href="${path }/Login"
								class="nav-link logout"> <span class="d-none d-sm-inline">离开</span><i
		...
		<div class="page-content d-flex align-items-stretch">
			...
			<nav class="side-navbar">
              ...
              <p>编号：${admin.aid }</p>
				...
				<span class="heading">列表</span>
				<ul class="list-unstyled">
					<li><a href="${path }/backstage2/index.jsp"> <i
					...
					<li><a href="#exampledropdownDropdown" aria-expanded="false"
						data-toggle="collapse"> <i class="icon-interface-windows"></i>用户信息管理
					</a>
					...
					<li><a href="#exampledropdownDropdown1" aria-expanded="false"
						data-toggle="collapse"> <i class="icon-grid"></i>比赛信息管理
					</a>
					...
					<li><a href="#exampledropdownDropdown2" aria-expanded="false"
						data-toggle="collapse"> <i class="icon-grid"></i>文章信息管理
					</a>
						<ul id="exampledropdownDropdown2" class="collapse list-unstyled ">
							<li><a href="${path }/CheckAllArticleServlet">文章查询</a></li>
							<li><a href="${path }/ArticleAllContentServlet">文章审核</a></li>
						</ul></li>
					<li><a href="#exampledropdownDropdown3" aria-expanded="false"
						data-toggle="collapse"> <i class="icon-padnote"></i>商品信息管理
					</a>
					...
					<li><a href="#exampledropdownDropdown4" aria-expanded="false"
						data-toggle="collapse"> <i class="icon-padnote"></i>论坛管理
					</a>
						<ul id="exampledropdownDropdown4" class="collapse list-unstyled ">

							<li><a href="${path }/CheckAllSend">论坛查询</a></li>
						</ul></li>
					<li><a href="#exampledropdownDropdown5" aria-expanded="false"
						data-toggle="collapse"> <i class="icon-padnote"></i>网站导航管理
					</a>
					...
					<li><a href="#exampledropdownDropdown6" aria-expanded="false"
						data-toggle="collapse"> <i class="icon-padnote"></i>网站内容管理
					</a>
			...
			<div class="content-inner" style="width: 1600px">
				<!-- Page Header-->
				<header class="page-header">
					<div class="container-fluid">
						<h2 class="no-margin-bottom">网站消息管理</h2>
					</div>
				</header>
				<!-- Breadcrumb-->
				...
				<!-- Forms Section-->
				<section class="forms" style="width: 2170px; margin-top: -15px">
					<div class="container-fluid">
						<div class="row">
							<!-- Horizontal Form-->
							<div class="col-lg-6">
										...
										<div class="dropdown">
											...
											<div aria-labelledby="closeCard2"
												...
												<a href="#" class="dropdown-item remove"> <i
													class="fa fa-times"></i>离开
												</a><a href="#" class="dropdown-item edit"> <i
													class="fa fa-gear"></i>关闭
												</a>
											</div>
										</div>
									</div>
									<div class="card-header d-flex align-items-center">
										<h3 class="h4">比赛报名用户展示</h3>
									</div>
									<div class="card-body">
											...
											<c:forEach items="${list }" var="t" varStatus="i">
												<table class="table">
													...
													<tbody>
														<tr>
															...
															<form
																action="${path }/updateMatchServlet2?mid=${t.match.mid}"
																method="post">
																<td><input style="color: #3DB3E4;"
																	value="${t.match.name }" name="name"></td>
																<td><input value="${t.match.starttime }"
																	name="starttime"></td>
																<td><input value="${t.match.uptime }" name="uptime"></td>
																<c:if test="${t.match.state==0 }">
																	<td><input style="color: #777777;" value="未开始"
																		readonly="readonly"></td>
																</c:if>
																<c:if test="${t.match.state==1 }">
																	<td><input style="color: #68FF6B;" value="进行中"
																		readonly="readonly"></td>
																</c:if>
																<c:if test="${t.match.state==2 }">
																	<td><input style="color: #FF0004;" value="已结束"
																		readonly="readonly"></td>
																</c:if>
																...
																<c:if test="${t.match.state==2 }">
																	<td><input type="button" class="btn btn-primary"
																		value="已下线" style="width: 60px; padding-right: 5px"></td>
																</c:if>
																<c:if test="${t.match.state!=2 }">
																	<td><input type="button" class="btn btn-primary"
																		value="下线" style="width: 60px"
																		onclick="window.location.href='${path}/XXMatchServlet2?mid=${t.match.mid }'"></td>
																</c:if>

																<td><input type="button" class="btn btn-primary"
																	value="删除" style="width: 60px"
																	onclick="window.location.href='${path}/delMatchServlet2?mid=${t.match.mid }'"></td>
															</form>
														</tr>
													</tbody>
												...
												<div
													...
													<table class="table">
														...
														<tbody>
															<c:forEach items="${t.list }" var="u" varStatus="j">
																<tr>
																	<th scope="row">${j.index+1 }</th>
																	<form>
																		<td><input style="color: #731900"
																			value="${u.name }"></td>
																		<td><input value="${u.time }"></td>
																		<c:if test="${u.state==1 }">
																			<td><input style="color: #4A02A4;" value="已报名"></td>
																		</c:if>
																		<c:if test="${u.state!=1 }">
																			<td><input style="color: #4A02A4;" value="未报名"></td>
																		</c:if>

																		<td><input style="color: #225101;"
																			value="${u.mname }"></td>
																		<td><input type="button" class="btn btn-primary"
																			style="width: 60px" value="删除"
																			onclick="window.location.href='${path}/delMuserServlet?id=${u.id }'"></td>
																	</form>
																</tr>
															</c:forEach>
	...
	<script src="${path }/backstage2/vendor/popper.js/umd/popper.min.js">
		
	</script>
	<script src="${path }/backstage2/vendor/bootstrap/js/bootstrap.min.js"></script>
	<script src="${path }/backstage2/vendor/jquery.cookie/jquery.cookie.js">
		
	</script>
	<script src="${path }/backstage2/vendor/chart.js/Chart.min.js"></script>
	<script
		src="${path }/backstage2/vendor/jquery-validation/jquery.validate.min.js"></script>
	<!-- Main File-->
