...
<!--                    <li><a href="${path }/backstage2/forms.jsp"> <i class="icon-padnote"></i>网站信息管理 </a></li>-->
        ...
        <div class="content-inner">
          ...
          <section class="forms" style="width: 2170px;margin-top: -15px"> 
			...
			<section class="forms" style="width: 1640px; margin-top: -100px;"> 
            <div class="container-fluid">
              <div class="row">
                <!-- Basic Form-->
                <div class="col-lg-8">                           
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form class="form-inline">
                        <div class="form-group">
                          <label for="inlineFormInput" class="sr-only">商品名称</label>
                          <input id="inlineFormInput1" type="text" placeholder="商品名称" class="mr-3 form-control">
                        </div>
                        <div class="form-group">
                          <label for="inlineFormInputGroup" class="sr-only">商品价格</label>
                          <input id="inlineFormInputGroup1" type="text" placeholder="商品价格" class="mr-3 form-control">
                        </div>
						  <div class="form-group">
                          <label for="inlineFormInputGroup" class="sr-only">商品数量</label>
                          <input id="inlineFormInputGroup2" type="text" placeholder="商品数量" class="mr-3 form-control">
                        </div>
