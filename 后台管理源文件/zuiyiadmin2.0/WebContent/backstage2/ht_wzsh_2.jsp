                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">待审核摄影图片1</h3>
                    </div>
                    <c:forEach items="${findAllSy }" var="t">
                    <div class="card-body">
						<div style="float: left; width: 130px;margin-left: 0px">用户名</div>
						<div style="float: left; width: 130px;margin-left: 80px">摄影名称</div>
						<div style="float: left; width: 130px;margin-left: 80px">摄影介绍内容</div>
                        ...
                        <td><input value="${t.username }" style="border: 0px"></td>
                              <td><input value="${t.shoottitle }" style="border: 0px"></td>
                              <td><input value="${t.shootintroduce }" style="border: 0px"></td>
							  <td><input value="${t.shootdate }" style="border: 0px"></td>
                      ...
                      <form class="form-horizontal" action="${path }/WorksServlet?action=Shenhe&shootid=${t.shootid}&userid=${t.userid}" method="post">
