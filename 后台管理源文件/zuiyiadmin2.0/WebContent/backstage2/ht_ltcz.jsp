...
<!--                    <li><a href="${path }/backstage2/forms.jsp"> <i class="icon-padnote"></i>网站信息管理 </a></li>-->
        ...
        <div class="content-inner">
          <!-- Page Header-->
          <header class="forms" style="width: 1200px; margin-top: -15px">
            <div class="container-fluid">
          ...
          <!-- Forms Section-->
          <section class="forms" style="width: 1600px; margin-top: -15px"> 
            <div class="container-fluid">
              <div class="row">
                <!-- Basic Form-->
                <div class="col-lg-8">                           
                  <div class="card">
                    <div class="card-close">
                      <div class="dropdown">
                        ...
                        <div aria-labelledby="closeCard3" class="dropdown-menu dropdown-menu-right has-shadow"><a href="#" class="dropdown-item remove"> <i class="fa fa-times"></i>关闭</a><a href="#" class="dropdown-item edit"> <i class="fa fa-gear"></i>离开</a></div>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                      <form class="form-inline" action="${path }/CheckSendServlet" method="post">
                        <div class="form-group">
                          <label for="inlineFormInput" class="sr-only">论坛作者</label>
                          <input id="inlineFormInput" type="text" placeholder="论坛作者" class="mr-3 form-control" name="name">
                        </div>
                        <div class="form-group">
                          <label for="inlineFormInputGroup" class="sr-only">论坛标题</label>
                          <input id="inlineFormInputGroup" type="text" placeholder="论坛标题" class="mr-3 form-control" name="title">
                        </div>
                        <div class="form-group">
			...
			<section class="forms" style="width: 1600px; margin-top: -100px" > 
            <div class="container-fluid">
              <div class="row">
                <!-- Basic Form-->
                <div class="col-lg-8">                           
                  <div class="card">
                   ...
                   <c:if test="${BZ==1 }">
                    <c:forEach items="${findAllSend }" var="t">
                     <div class="card-body">
                      <form class="form-inline">
                        <div class="form-group">
                          <label for="inlineFormInput" class="sr-only">论坛作者</label>
                          <input id="inlineFormInput1" type="text" placeholder="论坛作者" class="mr-3 form-control" value="${t.name }">
                        </div>
                        <div class="form-group">
                          <label for="inlineFormInputGroup" class="sr-only">论坛标题</label>
                          <input id="inlineFormInputGroup1" type="text" placeholder="论坛标题" class="mr-3 form-control" value="${t.title }">
                        </div>
                        <div class="form-group">
                           <input type="button" class="btn btn-primary" value="删除"  style="width: 60px"  onclick="window.location.href='${path}/delSendServlet?action=delSend1&tid=${t.tid }'">
                        </div>
                      </form>
                    </div>
                    <hr>
                 ...
                 <c:if test="${BZ==0 }">
                     ...
                     <div class="card-body">
                      <form class="form-inline">
                        <div class="form-group">
                          <label for="inlineFormInput" class="sr-only">论坛作者</label>
                          <input id="inlineFormInput1" type="text" placeholder="论坛作者" class="mr-3 form-control" value="${findSend.name }">
                        </div>
                        <div class="form-group">
                          <label for="inlineFormInputGroup" class="sr-only">论坛标题</label>
                          <input id="inlineFormInputGroup1" type="text" placeholder="论坛标题" class="mr-3 form-control" value="${findSend.title }">
                        </div>
                        <div class="form-group">
                          <input type="button" class="btn btn-primary" value="删除"  style="width: 60px"  onclick="window.location.href='${path}/delSendServlet?action=delSend2&tid=${findSend.tid }'">
                        </div>
                      </form>
                    </div>
                    <hr>
