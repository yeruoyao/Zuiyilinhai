                ...
                <div class="col-lg-6">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">比赛信息发布</h3>
                    </div>
                    <div class="card-body">
                      <p>发布一些临海比赛的信息</p>
                      <form class="form-horizontal" action="${path }/MatchServlet" method="post" enctype="multipart/form-data">
                        <div class="form-group row" >
                          <label class="col-sm-3 form-control-label">比赛名称:</label>
                          <div class="col-sm-9">
                            <input id="inputHorizontalSuccess" type="text" placeholder="比赛名称" name="name" class="form-control form-control-success" ><small class="form-text">比赛名称</small>
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">比赛开始时间:</label>
                          <div class="col-sm-9">
                            <input id="inputHorizontalWarning" type="date" placeholder="比赛开始时间" name="starttime" class="form-control form-control-warning"><small class="form-text">比赛开始时间</small>
                          </div>
                        </div>
						  <div class="form-group row">
                          <label class="col-sm-3 form-control-label">比赛结束时间:</label>
                          <div class="col-sm-9">
                            <input id="inputHorizontalWarning1" type="date" placeholder="比赛结束时间" name="uptime" class="form-control form-control-warning"><small class="form-text">比赛结束时间</small>
                          </div>
                        </div>
						  <div class="form-group">       
                          <label class="form-control-label">比赛图片：</label>
							<br>
                         <input type="file" placeholder="比赛图片"  name="photo">
                        </div>
                        <div class="form-group row">       
