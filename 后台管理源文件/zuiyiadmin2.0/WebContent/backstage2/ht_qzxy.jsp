                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                            <c:forEach items="${wishs }"  var="it" varStatus="w">
                            	<tr>
		                            <th scope="row">${w.index+1 }</th>
									<form action="${path }/WishController" method="post">
									 	<input type="hidden" name="wid" value="${it.wid }">
				                        <td><input value="${wish.wishtext }"></td>
				                        <td><input value="诚希汝愿达！" class="wznr"></td>
										<td><button type="submit" class="btn btn-primary">删除该标签</button></td>
				                    </form>
	                            </tr>
                            </c:forEach>
