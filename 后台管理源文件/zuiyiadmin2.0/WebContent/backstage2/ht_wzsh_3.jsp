                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">待审核航拍视频1</h3>
                    </div>
                    <c:forEach items="${findAllVideo }" var="t">
                     <div class="card-body">
						<div style="float: left; width: 130px;margin-left: 0px">用户名</div>
						<div style="float: left; width: 130px;margin-left: 80px">航拍视频名称</div>
						<div style="float: left; width: 130px;margin-left: 80px">航拍介绍内容</div>
						<div style="float: left; width: 130px;margin-left: 70px">发布时间</div>

						<br>
						<br>
						<tr>
						<form>
                        <td><input value="${t.username }" style="border: 0px"></td>
                              <td><input value="${t.videotitle }" style="border: 0px"></td>
                              <td><input value="${t.videocontent }" style="border: 0px"></td>
							  <td><input value="${t.videotime }" style="border: 0px"></td>
                      ...
                      <form class="form-horizontal" method="post" action="${path }/WorksServlet?action=Vshenhe&videoid=${t.videoid}&userid=${t.userid}">
                        <div class="form-group row">
                          <div class="col-sm-9">
                            <div class="i-checks">
                              <input id="radioCustom1" type="radio" value="1" name="state" class="radio-template">
                              <label for="radioCustom1">通过审核</label>
                            </div>
                            <div class="i-checks">
                              <input id="radioCustom2" type="radio" checked="" value="0" name="state" class="radio-template">
                        ...
                        <div class="line"></div>
                        <div class="form-group row" >
                          <div class="col-sm-4 offset-sm-3" style="margin-left: 200px;">
