                        ...
                        <table class="table">
                          <thead>
                            <tr>
                         	...
                         	<tbody>
													<c:forEach items="${findAllTbUser1 }" var="t" varStatus="i">
														<tr>
															<th scope="row">${i.index+1 }</th>
																<form action="${path }/UpdateTbUserServlet1" method="post">
															...
															<td><input value="${t.membertime }"readonly="readonly"></td>
															<td><button type="submit" class="btn btn-primary">修改</button></td>
																<c:if test="${t.state2==1 }">
																	<td><input type="button" value="禁言"
																		...
																		onclick="window.location.href='${path}/updateState2Servlet1?id=${t.id }&state2=1'"></td>
																</c:if>
																<c:if test="${t.state2!=1 }">
																	<td><input type="button" value="正常"
																		class="btn btn-primary" style="width: 60px"
																		onclick="window.location.href='${path}/updateState2Servlet1?id=${t.id }&state2=0'"></td>
																</c:if>

																<td><input type="button" value="注销"
																	class="btn btn-primary" style="width: 60px"
																	onclick="window.location.href='${path}/delTbUserServlet1?id=${t.id }'"></td>
															</form>
														</tr>
													</c:forEach>
