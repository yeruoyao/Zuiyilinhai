                   ...
                   <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>用户信息管理 </a>
					...
					<li><a href="#exampledropdownDropdown2" aria-expanded="false" data-toggle="collapse"> <i class="icon-grid"></i>文章信息管理 </a>
                      ...
                      <ul id="exampledropdownDropdown3" class="collapse list-unstyled ">
						...
						<li><a href="${path }/backstage2/ht_qzxy.jsp">订单管理</a></li>
                      </ul>
                    </li>
                   ...
                   <div class="card-body">
										<div class="table-responsive">
											<table class="table">
												...
												<tbody>
													<c:forEach items="${findAllTbUser2 }" var="t" varStatus="i">
														<tr>
															<th scope="row">${i.index+1 }</th>
															<form action="${path }/UpdateTbUserServlet2" method="post">
															<td style="display: none;"><input value="${t.id }"
																...
																<td><input value="${t.state }" name="state"></td>
																...
																<c:if test="${t.state2==1 }">
																	<td><input type="button" value="禁言"
																		...
																		onclick="window.location.href='${path}/updateState2Servlet2?id=${t.id }&state2=1'"></td>
																</c:if>
																<c:if test="${t.state2!=1 }">
																	<td><input type="button" value="正常"
																		class="btn btn-primary" style="width: 60px"
																		onclick="window.location.href='${path}/updateState2Servlet2?id=${t.id }&state2=0'"></td>
																</c:if>

																<td><input type="button" value="注销"
																	class="btn btn-primary" style="width: 60px"
																	onclick="window.location.href='${path}/delTbUserServlet2?id=${t.id }'"></td>
															</form>
