                ...
                <li class="nav-item dropdown"> <a id="messages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><i class="fa fa-envelope-o"></i><span class="badge bg-orange badge-corner">10</span></a>
                  <ul aria-labelledby="notifications" class="dropdown-menu">
                    <li><a rel="nofollow" href="#" class="dropdown-item d-flex"> 
                        <div class="msg-profile"> <img src="${path }/img/avatar-1.jpg" alt="..." class="img-fluid rounded-circle"></div>
                        <div class="msg-body">

                          <h3 class="h5">陈女士</h3><span>发送你给的信息</span>
                        </div></a></li>
                    <li><a rel="nofollow" href="#" class="dropdown-item d-flex"> 
                        <div class="msg-profile"> <img src="${path }/img/avatar-2.jpg" alt="..." class="img-fluid rounded-circle"></div>
                        <div class="msg-body">
                          <h3 class="h5">威廉詹姆士</h3><span>发送给你信息</span>
                        </div></a></li>
                    <li><a rel="nofollow" href="#" class="dropdown-item d-flex"> 
                        <div class="msg-profile"> <img src="${path }/img/avatar-3.jpg" alt="..." class="img-fluid rounded-circle"></div>
                        <div class="msg-body">
      ...
      <div class="page-content d-flex align-items-stretch"> 
		...
		<nav class="side-navbar">
          ...
          <div class="sidebar-header d-flex align-items-center">
            <div class="avatar"><img src="${path }/img/avatar-1.jpg" alt="..." class="img-fluid rounded-circle"></div>
            <div class="title">
              <h1 class="h4">用户名</h1>
              <p>编号：${admin.aid }</p>
            </div>
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                            <c:forEach items="${orders }" var="it" varStatus="o">
                            	<tr>
			                       <th scope="row">${o.index+1 }</th>
			                        <td><input value="${it.orderid }"></td>
		                              	<td><input value="${it.goodsid }"></td>
		                              	<td><input value="${it.goodsname }" class="wznr"></td>
									  	<td><input value="${it.orderaddress }"></td>
									  	<td><input value="${it.orderphone }"></td>
										<td><input value="${it.orderamount }"></td>
									  	<td><input value="${it.ordermoney }"></td>
										<td><input value="${it.username }"></td>
									  	<td><input value="${it.orderstate }" style="color:blue;"></td>
									<form action="${path }/OrderController" method="post">
										<input type="hidden" name="orderid" value="${it.orderid }">
										<input type="hidden" name="action" value="delete">
										<td><button type="submit" class="btn btn-primary">删除订单</button></td>
			                      	</form>
			                      	<form action="${path }/OrderController" method="post">
			                      		<input type="hidden" name="orderid" value="${it.orderid }">
										<input type="hidden" name="action" value="send">
										<td><button type="submit" class="btn btn-primary">确认发货</button></td>
			                      	</form>
	                            </tr>
                            </c:forEach>
                          </tbody>
