										...
										<div class="card-body">
											<div class="table-responsive">
												<table class="table">
													...
													<tbody>
															<% 
																List<Fyxm> list=(List)request.getAttribute("list");
															for(int i=0;i<list.size();i++){
															%>
														<tr> 
													
																<th scope="row"><%=list.get(i).getFyxmid() %></th>
																<td><%=list.get(i).getFyxmtitle() %></td>
																<td>
																<div   class=ellipsis_div     
									 								 style="width:170px;" title="somelongtext">
																	  <%=list.get(i).getFyxmtext() %></div>
																	
																</td>
																<td><%=list.get(i).getFyxmtime() %></td>
															
																<form action="<%=base %>FyxmUpdateController1" method="post">
	                              									<input name="fyxmid" value="<%=list.get(i).getFyxmid() %>" type="hidden"/>
	                              									<input name="fyxmtitle" value="<%=list.get(i).getFyxmtitle() %>" type="hidden">
	                              									<input name="fyxmtext" value="<%=list.get(i).getFyxmtext() %>" type="hidden">
	                              									
																	<td><button type="submit" class="btn btn-primary">更新</button></td>
																</form>
																
																<form action="<%=base%>FyxmController" method="post">
								                              	 	<input name="fyxmid" value="<%=list.get(i).getFyxmid() %>" type="hidden"/>
										   ...
										   <form action="<%=base %>FyxmAddController" >
