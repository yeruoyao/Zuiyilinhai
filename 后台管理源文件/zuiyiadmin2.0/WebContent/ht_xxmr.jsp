										...
										<div class="card-body">
											<div class="table-responsive">
												<table class="table">
													...
													<tbody>
															<% 
																List<Xxmr> list=(List)request.getAttribute("list");
															for(int i=0;i<list.size();i++){
															%>
														<tr> 
													
																<th scope="row"><%=list.get(i).getXxmrid() %></th>
																<td><%=list.get(i).getXxmrtitle() %></td>
																<td>
																<div   class=ellipsis_div     
 								 style="width:170px;" title="somelongtext">
								  <%=list.get(i).getXxmrtext() %></div>
																	
																</td>
																<td><%=list.get(i).getXxmrtime() %></td>
															
																<form action="<%=base %>XxmrUpdateController1" method="post">
	                              									<input name="xxmrid" value="<%=list.get(i).getXxmrid() %>" type="hidden"/>
	                              									<input name="xxmrtitle" value="<%=list.get(i).getXxmrtitle() %>" type="hidden">
	                              									<input name="xxmrtext" value="<%=list.get(i).getXxmrtext() %>" type="hidden">
	                              									
																	<td><button type="submit" class="btn btn-primary">更新</button></td>
																</form>
																
																<form action="<%=base%>XxmrController" method="post">
								                              	 	<input name="xxmrid" value="<%=list.get(i).getXxmrid() %>" type="hidden"/>
										   ...
										   <form action="<%=base %>XxmrAddController" >
