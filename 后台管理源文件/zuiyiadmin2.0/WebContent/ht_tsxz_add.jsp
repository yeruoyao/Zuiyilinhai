										 ...
										 <section class="dashboard-counts no-padding-bottom">
							                  ...
							                  <div class="card">
							                    ...
							                    <div class="card-header d-flex align-items-center">
							                      <h3 class="h4">特色小镇-板块内容新增</h3>
							                    </div>
							                    <div class="card-body">
							                      <form class="form-horizontal" action="<%=base %>TsxzAddController" method="post">
							                       
							                        <div class="line"></div>
							                        <div class="form-group row">
							                          <label class="col-sm-2 form-control-label">标题</label>
							                          <div class="col-sm-9">
							                            <input type="text"  required="required" placeholder="请输入标题" name="tsxztitle" class="form-control">
							                          </div>
							                        </div>
							                        ...
							                        <div class="form-group row">
							                          ...
							                          <div class="col-sm-9">
							                            <textarea rows="" cols="" type="text" style="height: 150px"  required="required" placeholder="请输入内容" name="tsxztext" class="form-control"></textarea>
							                          </div>
							                        </div>
							                         ...
							                         <input type="text" id="flag" name="flag" value="submit" style="visibility: hidden"> 
							                       	<div class="form-group row">
													    ...
													    <div class="offset-sm-4">
													    	...
													    	<button id="clear" name="clear" onclick="Clear()" class="btn btn-primary">清空</button>
													    </div>
													</div>
