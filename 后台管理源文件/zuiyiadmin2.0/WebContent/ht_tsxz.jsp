										...
										<div class="card-body">
											<div class="table-responsive">
												<table class="table">
													...
													<tbody>
															<% 
																List<Tsxz> list=(List)request.getAttribute("list");
															for(int i=0;i<list.size();i++){
															%>
														<tr> 
													
																<th scope="row"><%=list.get(i).getTsxzid() %></th>
																<td><%=list.get(i).getTsxztitle() %></td>
																<td>
																<div   class=ellipsis_div     
									 								 style="width:170px;" title="somelongtext">
																	  <%=list.get(i).getTsxztext() %></div>
																	
																</td>
																<td><%=list.get(i).getTsxztime() %></td>
															
																<form action="<%=base %>TsxzUpdateController1" method="post">
	                              									<input name="tsxzid" value="<%=list.get(i).getTsxzid() %>" type="hidden"/>
	                              									<input name="tsxztitle" value="<%=list.get(i).getTsxztitle() %>" type="hidden">
	                              									<input name="tsxztext" value="<%=list.get(i).getTsxztext() %>" type="hidden">
	                              									
																	<td><button type="submit" class="btn btn-primary">更新</button></td>
																</form>
																
																<form action="<%=base%>TsxzController" method="post">
								                              	 	<input name="tsxzid" value="<%=list.get(i).getTsxzid() %>" type="hidden"/>
										   ...
										   <form action="<%=base %>TsxzAddController" >
