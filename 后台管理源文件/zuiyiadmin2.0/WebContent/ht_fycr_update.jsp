										 ...
										 <section class="dashboard-counts no-padding-bottom">
							                  ...
							                  <div class="card">
							                    ...
							                    <div class="card-header d-flex align-items-center">
							                      <h3 class="h4">非遗传人-板块内容更新</h3>
							                    </div>
							                    <div class="card-body">
							                 	  <%Fycr fycr=(Fycr)request.getAttribute("fycr"); %>
				
							                      <form class="form-horizontal" action="<%=base %>FycrUpdateController" method="post" >
							                        <input name="fycrid" value=<%=fycr.getFycrid()%> type="hidden"/>
							                        <div class="line"></div>
							                        <div class="form-group row">
							                          <label class="col-sm-2 form-control-label">标题</label>
							                          <div class="col-sm-9">
							                            <input type="text"  required="required" name="fycrtitle" value=<%=fycr.getFycrtitle()%> class="form-control">
							                          </div>
							                        </div>
							                        ...
							                        <div class="form-group row">
							                          ...
							                          <textarea style="height: 200px"  required="required" name="fycrtext" class="form-control"><%=fycr.getFycrtext() %></textarea>
