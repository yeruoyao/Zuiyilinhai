										 ...
										 <section class="dashboard-counts no-padding-bottom">
							                  ...
							                  <div class="card">
							                    ...
							                    <div class="card-header d-flex align-items-center">
							                      <h3 class="h4">非遗项目-板块内容更新</h3>
							                    </div>
							                    <div class="card-body">
							                 	  <%Fyxm fyxm=(Fyxm)request.getAttribute("fyxm"); %>
				
							                      <form class="form-horizontal" action="<%=base %>FyxmUpdateController" method="post" >
							                        <input name="fyxmid" value="<%=fyxm.getFyxmid()%>" type="hidden"/>
							                        <div class="line"></div>
							                        <div class="form-group row">
							                          <label class="col-sm-2 form-control-label">标题</label>
							                          <div class="col-sm-9">
							                            <input type="text"  required="required" name="fyxmtitle" value="<%=fyxm.getFyxmtitle()%>" class="form-control">
							                          </div>
							                        </div>
							                        ...
							                        <div class="form-group row">
							                          ...
							                          <textarea style="height: 200px"  required="required" name="fyxmtext" class="form-control"><%=fyxm.getFyxmtext() %></textarea>
