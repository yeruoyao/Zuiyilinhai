...
@WebServlet("/UpdateTbUserServlet")
public class UpdateTbUserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public UpdateTbUserServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(flag) {
				response.sendRedirect(request.getContextPath()+"/AllUserServlet");
			}else {
			}
